...
class account_invoice_report(osv.osv):
    ...
    def _select(self):
        select_str = """
            SELECT sub.id, sub.date, sub.year, sub.month, sub.day, sub.product_id, sub.partner_id, sub.state_id,
    ...
    def _sub_select(self):
        select_str = """
                SELECT min(ail.id) AS id,
                    ...
                    ail.product_id, ai.partner_id, pa.state_id, ai.payment_term, ai.period_id,
                    CASE
    ...
    def _from(self):
        from_str = """
                ...
                LEFT JOIN res_partner pa ON pa.id = ai.partner_id
        """
        return from_str
    ...
    def _group_by(self):
        group_by_str = """
                GROUP BY ail.product_id, ai.date_invoice, ai.id,
                    ...
                    ai.partner_id, pa.state_id, ai.payment_term, ai.period_id, u.name, ai.currency_id, ai.journal_id,
